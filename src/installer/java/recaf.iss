...
Name: "{app}\sendto+\sendto\Java\Recaf"; Filename: "{app}\java\recaf\recaf-2.21.13-J8-jar-with-dependencies.jar"; Components: "java\recaf"; IconFilename: "{app}\java\recaf\recaf.ico"